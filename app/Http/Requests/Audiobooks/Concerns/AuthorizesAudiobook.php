...
{
    /**
     * The routed collection must be an AUDIOBOOK — `collections` holds albums too, so a UUID-bound
     * route is not enough on its own: an album's id would otherwise resolve and be served as a book.
     */
