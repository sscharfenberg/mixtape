...
<template>
    <form class="form" novalidate @submit.prevent="enableTwoFactor(password)">
        <form-legend :items="legendItems">
            <template #intro>
                Die Zwei-Faktor Authentifizierung verwendet
                <strong>zeitlich limitierte Einmalpasswörter (TOTP)</strong>. Du benötigst eine entsprechende App,
                z.&nbsp;B. Google/Microsoft Authenticator oder
                <labelled-link href="https://bitwarden.com/">Bitwarden</labelled-link> /
                <labelled-link href="https://www.enpass.io/">Enpass</labelled-link>.
            </template>
            <template #confirm> Zum Aktivieren muss das Passwort angegeben werden. </template>
        </form-legend>
        ...
        <form-row>
            <Button variant="primary" type="submit" :disabled="processing">
                ...
                <span>{{ processing ? "Wird aktiviert …" : "2FA aktivieren" }}</span>
            </Button>
        </form-row>
    </form>
</template>
